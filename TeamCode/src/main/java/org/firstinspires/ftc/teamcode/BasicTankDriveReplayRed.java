...
//DECLARE TELEOP
@Autonomous(name="Teleop Driving Playback Red", group="Linear Opmode")  // @Autonomous(...) is the other common choice
public class BasicTankDriveReplayRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        try
        {
            ...
            File file = new File(sdCard,"recorderRed.txt");
